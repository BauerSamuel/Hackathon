    ...
    getPostsTemplate() {
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button class="btn btn btn-danger shadow" onclick="app.controllers.postController.postHot('${this._id}')">Hot <i class="fas fa-fire"></i></button><div id="hot-counter"># hot: ${this.postHot}</div><br>
